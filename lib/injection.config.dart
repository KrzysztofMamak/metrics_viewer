...
import 'sign_in_form_bloc/sign_in_form_bloc.dart'
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i8.AuthGuard>(() => _i8.AuthGuard(get<_i4.IAuthRepository>()));
  gh.lazySingleton<_i9.AppRouter>(
      () => _i9.AppRouter(authGuard: get<_i8.AuthGuard>()));
  return get;
}
